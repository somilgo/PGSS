...
# Your BFS function can go here :)
def findGoalWithBreadthFirstSearch(state):
  global exploredStates
  exploredStates = 0
  result = findGoalWithBreadthFirstSearchHelper(state)
  print "Explored states: ", exploredStates
  return result

def findGoalWithBreadthFirstSearchHelper(state):
  global exploredStates
  seenBoards = set()
  if (isGoalState(state)):
    print "goal state! yay!"
...
solution = findGoalWithBreadthFirstSearch(board)
print getMovesToState(solution)
